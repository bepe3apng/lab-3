...
glAlphaFunc(GL_GREATER, 0.99);
   ...
   float left=(charsizex*NumberOfSprite)/spriteXsize+50; //вычисление координат кадра на изображении от
                   ...
                   int nCmdShow)
{
    ...
    Texture_LoadTexture("picture.png",&textureId,GL_REPEAT,GL_NEAREST, NULL);
